              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final Picture picture = widget.game.pictures[index];
                                      ...
                                      SizedBox(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(picture.userOwner.username!,
                                                  style: TextStyle(
                                                    fontSize: 2.1.h,
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            if (!votes.any((v) =>
                                              ...
                                              setState(() {
                                                bool hasVoteWithSameIdAndPoint =
                                                    votes.any((v) =>
                                                        v.id == pictureId &&
                                                        v.point == i);
                ...
                InkWell(
                  ...
                  borderRadius: const BorderRadius.all(Radius.circular(10)),
                  onTap: () {
                    if (votes.length == widget.game.pictures.length) {
